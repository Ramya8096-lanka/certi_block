...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden relative bg-gradient-to-br from-amber-900 via-orange-900 to-red-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute inset-0">
          {[...Array(50)].map((_, i) => (
            ...
            >
              <Star className="w-1 h-1 text-orange-400 animate-pulse" />
            </div>
          ))}
        </div>

        {/* Dynamic gradient orbs */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-orange-600 to-coral-600 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-gradient-to-r from-teal-400 to-cyan-600 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
        <div className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-gradient-to-r from-amber-400 to-orange-600 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
        
        {/* Glowing grid overlay */}
        <div className="absolute inset-0 bg-gradient-to-t from-transparent via-orange-900/10 to-transparent" 
             style={{
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <header className="text-center mb-12 animate-fade-in-up">
          <div className="flex justify-center items-center mb-6 relative">
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-orange-600 to-teal-600 rounded-full blur-lg group-hover:blur-xl transition-all duration-300 opacity-70 animate-pulse"></div>
              <div className="relative bg-gradient-to-r from-amber-900 to-orange-900 p-4 rounded-full border border-orange-500/30">
                <Shield className="w-16 h-16 text-transparent bg-gradient-to-r from-orange-400 via-coral-400 to-teal-400 bg-clip-text animate-pulse" />
              </div>
              <Verified className="w-8 h-8 text-teal-400 absolute -top-2 -right-2 animate-bounce drop-shadow-lg" />
            </div>
          </div>
          
          <div className="relative">
            <h1 className="text-7xl font-extrabold mb-6 relative">
              <span className="bg-gradient-to-r from-orange-400 via-coral-400 to-teal-400 bg-clip-text text-transparent animate-shimmer">
                CertiBlock
              </span>
              <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-coral-400 to-teal-400 bg-clip-text text-transparent blur-sm opacity-50 animate-pulse"></div>
            </h1>
            
            <div className="flex justify-center mb-4">
              <Sparkles className="w-6 h-6 text-amber-400 animate-spin mx-2" />
              <Sparkles className="w-4 h-4 text-coral-400 animate-bounce mx-1" />
              <Sparkles className="w-5 h-5 text-teal-400 animate-pulse mx-2" />
            </div>
          </div>
          
          <p className="text-2xl text-orange-200 max-w-3xl mx-auto leading-relaxed font-light mb-6">
            Next-Generation Blockchain Certificate Verification System
          </p>
          
          <div className="flex justify-center">
            <div className="h-1 w-32 bg-gradient-to-r from-orange-500 via-coral-500 to-teal-500 rounded-full animate-pulse"></div>
          </div>
        </header>
        ...
        <div className="max-w-md mx-auto mb-12">
          {!wallet.isConnected ? (
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-orange-600 to-teal-600 rounded-3xl blur opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
              <div className="relative bg-amber-800/80 backdrop-blur-xl border border-amber-700/50 rounded-3xl shadow-2xl p-8 hover:shadow-orange-500/20 transition-all duration-500 hover:scale-105">
                <div className="text-center">
                  <div className="relative mb-6">
                    <div className="w-20 h-20 bg-gradient-to-r from-orange-600 to-teal-600 rounded-full flex items-center justify-center mx-auto animate-pulse">
                      <Wallet className="w-10 h-10 text-white" />
                    </div>
                    <div className="absolute inset-0 bg-gradient-to-r from-orange-600 to-teal-600 rounded-full blur-xl opacity-30 animate-pulse"></div>
                  </div>
                  
                  <h3 className="text-2xl font-bold text-white mb-3">Connect Wallet</h3>
                  <p className="text-orange-300 mb-6">Secure blockchain verification requires wallet connection</p>
                  ...
                  <button
                    ...
                    className="w-full relative bg-gradient-to-r from-orange-600 via-coral-600 to-teal-600 text-white px-8 py-4 rounded-2xl font-semibold shadow-xl hover:shadow-2xl transform transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none overflow-hidden group"
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-orange-600 via-coral-600 to-teal-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-shimmer"></div>
            ...
            <div className="relative group animate-scale-in">
              <div className="absolute inset-0 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-3xl blur opacity-20 animate-pulse"></div>
              <div className="relative bg-teal-500/10 border border-teal-500/30 rounded-3xl shadow-2xl p-8 backdrop-blur-xl">
                <div className="text-center">
                  <div className="relative mb-6">
                  ...
                  <div className="bg-amber-800/50 backdrop-blur-sm rounded-2xl p-4 mb-4 border border-teal-500/20">
                    <p className="text-orange-200 text-sm font-mono break-all">
                      {wallet.address}
                    </p>
                  </div>
                  <button
        ...
        {wallet.isConnected ? (
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8 mb-12">
              ...
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r from-amber-600 to-orange-600 rounded-3xl blur opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
                <div className="relative bg-amber-800/80 backdrop-blur-xl border border-amber-700/50 rounded-3xl shadow-2xl p-8 hover:shadow-amber-500/20 transition-all duration-500 hover:scale-105">
                  <div className="flex items-center mb-8">
                    <div className="w-12 h-12 bg-gradient-to-r from-amber-500 to-orange-500 rounded-2xl flex items-center justify-center mr-4 animate-pulse">
                  ...
                  <div className="relative">
                    ...
                    <label
                      ...
                      className="relative flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-amber-400/30 rounded-2xl cursor-pointer bg-gradient-to-br from-amber-500/5 to-orange-500/5 hover:border-amber-400/50 transition-all duration-300 group backdrop-blur-sm overflow-hidden"
                    >
                      ...
                      <div className="relative z-10 flex flex-col items-center justify-center pt-5 pb-6">
                        {showUploadAnimation ? (
                          <div className="animate-bounce">
                            <div className="w-20 h-20 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full flex items-center justify-center mb-4 animate-pulse">
                              <CheckCircle className="w-10 h-10 text-white" />
                            </div>
                            <p className="text-teal-400 font-semibold text-lg">File uploaded successfully!</p>
                          </div>
                        ) : (
                          <>
                            <div className="w-16 h-16 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                              <Upload className="w-8 h-8 text-white" />
                            </div>
                            <p className="mb-2 text-lg text-orange-200 font-medium">
                              <span className="font-semibold">Click to upload</span> or drag and drop
                            </p>
                            <p className="text-sm text-orange-300">PDF, JPG, PNG, WebP (MAX. 10MB)</p>
                          </>
                        )}
                      </div>
                    </label>
                    ...
                    {uploadedFile && (
                      <div className="mt-6 p-6 bg-amber-700/30 backdrop-blur-sm rounded-2xl border border-amber-600/30 animate-slide-in">
              ...
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r from-teal-600 to-cyan-600 rounded-3xl blur opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
                <div className="relative bg-amber-800/80 backdrop-blur-xl border border-amber-700/50 rounded-3xl shadow-2xl p-8 hover:shadow-teal-500/20 transition-all duration-500 hover:scale-105">
                  <div className="flex items-center mb-8">
                    <div className="w-12 h-12 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-2xl flex items-center justify-center mr-4 animate-pulse">
                  ...
                  <div className="space-y-6">
                    <div>
                      <label className="block text-lg font-medium text-orange-200 mb-3">
                        Certificate Hash
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full px-6 py-4 bg-amber-700/30 backdrop-blur-sm border border-amber-600/30 rounded-2xl focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500/50 transition-all duration-300 font-mono text-sm text-white placeholder-orange-300"
                        disabled={!wallet.isConnected}
                      />
                      <p className="text-xs text-orange-300 mt-2 leading-relaxed">
                    ...
                    <div className="flex space-x-4">
                      <button
                        ...
                        className="flex-1 relative bg-gradient-to-r from-teal-600 via-cyan-600 to-emerald-600 text-white px-8 py-4 rounded-2xl font-semibold shadow-xl hover:shadow-2xl transform transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none overflow-hidden group"
                      >
                      ...
                      <button
                        ...
                        className="px-6 py-4 border border-amber-600/50 rounded-2xl text-orange-200 hover:bg-amber-700/30 hover:border-amber-500/50 transition-all duration-300 backdrop-blur-sm"
                      >
                        Clear
                      </button>
                    </div>
            ...
            {(verificationResult.certificate || verificationResult.error) && (
              <div className="max-w-6xl mx-auto animate-scale-in">
                {verificationResult.certificate ? (
                  <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-3xl blur opacity-20 animate-pulse"></div>
                    <div className="relative bg-gradient-to-br from-teal-500/10 to-cyan-500/10 border border-teal-500/30 rounded-3xl shadow-2xl p-8 backdrop-blur-xl">
                      <div className="flex items-center mb-8">
                        <div className="relative">
                          <div className="w-20 h-20 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full flex items-center justify-center mr-6 animate-pulse">
                            <CheckCircle className="w-10 h-10 text-white" />
                          </div>
                          <div className="absolute inset-0 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full blur-xl opacity-40 animate-pulse"></div>
                        </div>
                        <div>
                          <h3 className="text-4xl font-bold text-white mb-2">Verified Certificate</h3>
                          <p className="text-teal-300 font-semibold text-lg">Government Database Match Found</p>
                        </div>
                      </div>
                      
                      <div className="grid md:grid-cols-2 gap-8">
                        <div className="space-y-6">
                          <div className="bg-amber-800/50 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-amber-700/30">
                            <h4 className="font-bold text-white mb-4 text-xl">Certificate Details</h4>
                            <div className="space-y-3">
                              <div className="flex justify-between items-center">
                                <span className="font-medium text-orange-200">ID:</span> 
                                <span className="text-white font-mono text-sm">{verificationResult.certificate.id}</span>
                              </div>
                              <div className="flex justify-between items-start">
                                <span className="font-medium text-orange-200">Type:</span> 
                                <span className="text-white text-right max-w-xs">{verificationResult.certificate.certificateType}</span>
                              </div>
                              <div className="flex justify-between items-center">
                                <span className="font-medium text-orange-200">Holder:</span> 
                                <span className="text-white">{verificationResult.certificate.holderName}</span>
                              </div>
                              <div className="flex justify-between items-start">
                                <span className="font-medium text-orange-200">Issuer:</span> 
                        ...
                        <div className="space-y-6">
                          <div className="bg-amber-800/50 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-amber-700/30">
                            ...
                            <div className="space-y-3">
                              <div className="flex justify-between items-start">
                                <span className="font-medium text-orange-200">Institution:</span> 
                                <span className="text-white text-right max-w-xs">{verificationResult.certificate.metadata?.institution}</span>
                              </div>
                              <div className="flex justify-between items-start">
                                <span className="font-medium text-orange-200">Course:</span> 
                                <span className="text-white text-right max-w-xs">{verificationResult.certificate.metadata?.course}</span>
                              </div>
                              <div className="flex justify-between items-center">
                                <span className="font-medium text-orange-200">Grade:</span> 
                                <span className="text-teal-400 font-semibold">{verificationResult.certificate.metadata?.grade}</span>
                              </div>
                              <div className="flex justify-between items-center">
                                <span className="font-medium text-orange-200">Issue Date:</span> 
                      ...
                      {verificationResult.certificate.metadata?.verificationUrl && (
                        <div className="mt-8 p-6 bg-amber-800/50 backdrop-blur-sm rounded-2xl shadow-lg border border-amber-700/30">
                          <div className="flex items-center justify-between">
                            <div>
                              <h4 className="font-bold text-white text-lg mb-2">Official Verification Link</h4>
                              <p className="text-sm text-orange-200 font-mono break-all">
                                {verificationResult.certificate.metadata.verificationUrl}
                              </p>
                            </div>
                            <button className="flex items-center px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-300 ml-4">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-r from-amber-500 to-orange-500 rounded-3xl blur opacity-20 animate-pulse"></div>
                    <div className="relative bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/30 rounded-3xl shadow-2xl p-8 backdrop-blur-xl">
                      <div className="flex items-center mb-8">
                        <div className="relative">
                          <div className="w-20 h-20 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full flex items-center justify-center mr-6 animate-pulse">
                            <FileText className="w-10 h-10 text-white" />
                          </div>
                          <div className="absolute inset-0 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full blur-xl opacity-40 animate-pulse"></div>
                        </div>
                        <div>
                          <h3 className="text-4xl font-bold text-white mb-2">Real Certificate Detected</h3>
                          <p className="text-amber-300 font-semibold text-lg">Manual Verification Required</p>
                        </div>
                      </div>
                      
                      <div className="bg-amber-800/50 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-amber-700/30 mb-8">
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center">
                            ...
                            <span className="text-orange-200">File appears to be a legitimate educational certificate</span>
                          </div>
                          <div className="flex items-center">
                            <CheckCircle className="w-6 h-6 text-teal-400 mr-3" />
                            <span className="text-orange-200">Document structure matches standard certificate format</span>
                          </div>
                          <div className="flex items-center">
                            <AlertTriangle className="w-6 h-6 text-amber-400 mr-3" />
                            <span className="text-orange-200">Requires official board verification for authenticity</span>
                          </div>
                        </div>
                      </div>
                      
                      <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 mb-6 backdrop-blur-sm">
                        <h4 className="font-bold text-amber-200 mb-4 text-lg">Next Steps for Your 10th Certificate:</h4>
                        <div className="space-y-3 text-amber-100">
                          <div className="flex items-start">
                            <span className="font-bold mr-3 text-amber-300">1.</span>
                            <span>Contact your school or education board (CBSE/ICSE/State Board) for official digital verification</span>
                          </div>
                          <div className="flex items-start">
                            <span className="font-bold mr-3 text-amber-300">2.</span>
                            <span>Visit the official board website to check for digital certificate services</span>
                          </div>
                          <div className="flex items-start">
                            <span className="font-bold mr-3 text-amber-300">3.</span>
                            <span>Some boards provide QR codes or unique verification numbers on certificates</span>
                          </div>
                          <div className="flex items-start">
                            <span className="font-bold mr-3 text-amber-300">4.</span>
                            <span>For immediate verification, contact your school's administrative office</span>
                          </div>
                        </div>
                      </div>
                      
                      <div className="bg-teal-500/10 border border-teal-500/30 rounded-2xl p-6 backdrop-blur-sm">
                        <div className="flex items-start">
                          <Shield className="w-6 h-6 text-teal-400 mr-3 mt-1" />
                          <div>
                            <p className="text-teal-300 font-bold text-lg mb-2">Your Certificate Appears Legitimate</p>
                  ...
                  <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-rose-500 rounded-3xl blur opacity-20 animate-pulse"></div>
                    <div className="relative bg-gradient-to-br from-red-500/10 to-rose-500/10 border border-red-500/30 rounded-3xl shadow-2xl p-8 backdrop-blur-xl">
                      <div className="flex items-center mb-8">
                        <div className="relative">
                          <div className="w-20 h-20 bg-gradient-to-r from-red-500 to-rose-500 rounded-full flex items-center justify-center mr-6 animate-pulse">
                            <XCircle className="w-10 h-10 text-white" />
                          </div>
                          <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-rose-500 rounded-full blur-xl opacity-40 animate-pulse"></div>
                        </div>
                        <div>
                        ...
                        <div className="space-y-4">
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <p className="text-orange-200 mt-2">{verificationResult.fakeDetails?.reason}</p>
                            </div>
                          </div>
                      ...
                      <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 backdrop-blur-sm">
                        <div className="flex items-start">
                          <AlertTriangle className="w-6 h-6 text-amber-400 mr-3 mt-1" />
                          <div>
                            <p className="text-amber-300 font-bold text-lg mb-2">Note About Online Certificates</p>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-gradient-to-br from-red-500/10 to-rose-500/10 border border-red-500/30 rounded-3xl shadow-2xl p-8 backdrop-blur-xl">
                      ...
                      <div className="bg-amber-800/50 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-amber-700/30">
                        ...
                        <p className="text-orange-200 mb-6 text-lg">{verificationResult.error}</p>
                        <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4 backdrop-blur-sm">
                          <div className="flex items-start">
                            <AlertTriangle className="w-6 h-6 text-amber-400 mr-3 mt-1" />
                            <div>
                              <p className="text-amber-300 font-bold mb-2">Security Warning</p>
                              <p className="text-amber-100">
          ...
          <div className="max-w-3xl mx-auto relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-orange-600 to-teal-600 rounded-3xl blur opacity-20"></div>
            <div className="relative bg-amber-800/80 backdrop-blur-xl border border-amber-700/50 rounded-3xl shadow-2xl p-12 text-center">
              <div className="flex justify-center mb-8">
                <div className="relative">
                  <div className="w-24 h-24 bg-gradient-to-r from-orange-600 to-teal-600 rounded-full flex items-center justify-center animate-pulse">
              ...
              <button
                onClick={connectWallet}
                className="bg-gradient-to-r from-orange-600 via-coral-600 to-teal-600 text-white px-8 py-4 rounded-2xl font-semibold shadow-xl hover:shadow-2xl transform transition-all duration-300 hover:scale-105 text-lg"
              >
                Connect Wallet Now
              </button>
            </div>
      ...
      <style jsx>{`
        ...
        ::-webkit-scrollbar-thumb {
          background: linear-gradient(to bottom, #ea580c, #0891b2);
          border-radius: 4px;
        }
        
        ::-webkit-scrollbar-thumb:hover {
          background: linear-gradient(to bottom, #dc2626, #0e7490);
        }
      `}</style>
    </div>
  );
